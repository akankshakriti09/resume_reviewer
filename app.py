...
with st.form(key='resume_form'):
    ...
    openai_api_key = st.text_input('OpenAI API Key', type='password', disabled=not (job_description and file),
                                   help="Insert the job description and file first. Then add the OpenAI API key here.")
    submitted = st.form_submit_button('Submit', disabled=not(job_description and file and openai_api_key))
